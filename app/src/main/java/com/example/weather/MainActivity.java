...
public class MainActivity extends AppCompatActivity {
     ...
     *  @return The language saved in the shared preferences.
     */
    ...
    public void fetchWeather(String city) {
        String accessKey = ""; //  Create New Key on weatherstack
            ...
            public void onResponse(JSONObject response) {
                try {
                    if (response.has("error")) {
                        ...
                        String info = errorObj.optString("info", "Unknown error");
                        Toast.makeText(MainActivity.this, "API Error: " + info, Toast.LENGTH_LONG).show();
                        return;
                    }
